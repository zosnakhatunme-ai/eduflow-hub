...
export function FloatingButtons({ course }: FloatingButtonsProps = {}) {
  ...
  const WELCOME_TEXT = "Assalamualaikum everyone, This is Ashikuzzaman, Your Ashik Vaiya. কিভাবে সাহায্য করতে পারি?";
  ...
  const handleChatSend = () => {
    ...
    const keywords: { match: string[]; reply: string; nav?: MenuScreen }[] = [
      ...
      { match: ["আমার কোর্স", "my course", "আমার", "enrolled", "content", "কন্টেন্ট", "classroom", "ক্লাসরুম"], reply: "🎓 আপনার কোর্সসমূহ:", nav: "content" },
        ...
        return (
          <div className="flex flex-wrap gap-2">
            ...
            {user && enrolledCourseIds.length > 0 && (
              <CapsuleButton icon={<GraduationCap className="h-3.5 w-3.5" />} label="আমার কোর্সসমূহ" onClick={() => navigateTo("content")} accent />
            )}
    ...
    <div className="fixed bottom-20 right-3 sm:right-4 z-40 flex flex-col gap-3 items-end">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            <div className="flex justify-start">
              <div className="max-w-[80%] rounded-lg px-3 py-2 text-sm bg-muted text-foreground">
                Assalamualaikum everyone, This is Ashikuzzaman, Your Ashik Vaiya. কিভাবে সাহায্য করতে পারি?
              </div>
            </div>
            {waHistory.map((msg, i) => (
      ...
      {menuOpen && !chatOpen && !whatsappOpen && (
        <div className="flex flex-col gap-3 items-end animate-fade-in">
          {/* Facebook button from socialLinks */}
          {(() => {
